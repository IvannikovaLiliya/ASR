...
class CTCTextEncoder:
    ...
    def __init__(
        ...
        alphabet=None,
        use_lm=False,
        kenlm_path="./data/lowercase_3-gram.pruned.1e-7.arpa",
        **kwargs,
    ):
        """
        Args:
        ...
        alphabet = list(dict(sorted(tokenizer.get_vocab().items(), key=lambda x: x[1])).keys())
    ...
    def beam_search_result(self, probs, beam_size=10):
        ...
        bs_result = self._ctc_beam_search(probs, beam_size)
